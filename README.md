...
Текущая версия для всех браузеров — `1.5.1`. Сборка Firefox универсальна для компьютеров и Firefox для Android 142+.
...
Готовые архивы версии 1.5.1 находятся в `dist/`. Инструкция для воспроизводимой сборки: [SOURCE_BUILD.md](SOURCE_BUILD.md). Изменения выпусков перечислены в [CHANGELOG.md](CHANGELOG.md).
